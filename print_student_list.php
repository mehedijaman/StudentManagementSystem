			...
			<div class="container">
				<div class="row">
					<div id="content" class="col-lg-12">
						...
						<div class="row">
							<div class="col-sm-12">
								<div class="page-header">
									<div class="clearfix">
									<br>
										<a href="print_student_list.php?action=show_all_students" class="btn btn-info"><i class="fa fa-user"></i><br>Show All Student</a>
										<a href="print_student_list.php?action=show_active_students" class="btn btn-info"><i class="fa fa-user"></i><br>Show Active Students</a>
										<a href="print_student_list.php?action=show_inactive_students" class="btn btn-info"><i class="fa fa-user"></i><br>Show Inactive Students</a>
										<a href="print_student_list.php?action=show_batchwise_students" class="btn btn-info"><i class="fa fa-user"></i><br>Show Batchwise Student</a>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="row">
							<div class="col-md-12">
							<a href="student_list.php" class="btn btn-warning"><i class="fa fa-chevron-left"></i> Back</a>
							<hr>
								<?php if (isset($batchwise)) { ?>
											<form action="print_student_list.php" method="post" role="form" enctype="multipart/form-data">
											...
											<table id="datatable2" cellpadding="0" cellspacing="0" border="0" class="datatable table table-striped table-bordered table-hover">
												...
												<tbody>
													...
													<tr>
														...
														<td>
															<?php 
																echo "<strong>Name: </strong>".$value['full_name']." <strong>Computer No:".$value['computer_no'];
																
															?>
														</td>
														<td><?php echo $value['mobile']; ?></td>
														<td><img class="img img-responsive img-thumbnail" width="30" src="<?php echo $value['image']; ?>" alt="Photo"></td>
													</tr>
													<?php } ?>
												</tbody>
												<tfoot>
